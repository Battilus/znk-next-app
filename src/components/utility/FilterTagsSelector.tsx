        ...
        <>
            {bffParams?.length &&
                <div className="flex flex-col gap-3.5 2xl:gap-0.97v">
                    <div className="text-matterhorn uppercase font-medium text-sm leading-18p 2xl:text-0.97v 2xl:leading-1.25v">{title}</div>
                    <div className="flex flex-wrap gap-[0.3125rem] 2xl:gap-[0.35vw]">
                        {bffParams.map(filterTag =>
                            ...
                            >
                                <div className="text-[0.625rem] 2xl:text-[0.69vw] leading-[0.8125rem] 2xl:leading-0.9v">{filterTag}</div>
                            </Button>)}
                    </div>
                </div>
            }
