...
const PartnersCard: FC<Props> = ({ logo, descriptionKey, t, isMobileScreen }) => {
  ...
  return (
    <div className={`h-full w-full flex items-center ${isMobileScreen ? 'grayscale-0 justify-center' : 'grayscale hover:grayscale-0'} transition delay-100 ease-linear cursor-pointer`}>
      <div
      ...
      {!isMobileScreen && (
        <div className={`flex flex-col gap-1.5 2xl:gap-[0.42vw] ${screenWidth >= TABLET_MIN_WIDTH ? 'text-matterhorn' : 'text-white'}`}>
