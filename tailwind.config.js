  ...
  theme: {
    extend: {
        ...
        backgroundImage: {
            ...
            'burro_command_hover_2': "url('/png/burro_command_hover_2.jpg')",
            'burro_achievements': "url('/png/burro_achievements.png')",
            'burro_achievements_hover': "url('/png/burro_achievements_hover.png')",
            'burro_achievements_mobile': "url('/png/burro_achievements_mobile.png')",
        },
    },
  },
  plugins: [
